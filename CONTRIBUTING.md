# Contributing to MicroProfile Starter Extension for IntelliJ
...
Please raise any bug reports on the [issue tracker](https://github.com/MicroShed/mp-starter-intellij-ext/issues). Be sure to search the list to see if your issue has already been raised.
